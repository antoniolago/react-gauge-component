...
export const addNeedleElement = (gauge: Gauge) => gauge.needle.current = gauge.g.current.append("g").attr("class", "needle");
export const clearNeedleElement = (gauge: Gauge) => gauge.needle.current.selectAll("*").remove();
