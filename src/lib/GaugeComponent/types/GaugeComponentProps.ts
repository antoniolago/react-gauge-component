...
export const getGaugeMarginByType = (type: string): GaugeInnerMarginInPercent | number => {
    let gaugeTypesMargin: Record<string, GaugeInnerMarginInPercent | number> = {
        [GaugeType.Grafana]: { top: 0.03, bottom: 0.00, left: 0.07, right: 0.07 },
        [GaugeType.Semicircle]: { top: 0.03, bottom: 0.00, left: 0.08, right: 0.08 },
        [GaugeType.Radial]: { top: 0.03, bottom: 0.00, left: 0.07, right: 0.07 },
    };
